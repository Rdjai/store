                ...
                <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
                    <div className="text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-gray-600 sm:text-xl leading-relaxed mb-10">
                            Connect with top-rated stores, explore authentic customer reviews, and make smarter shopping decisions. Join thousands who shop with confidence.                        </p>
                        {/* CTA buttons */}
